...
Publish-Package "packages\core"          "@afterlink/core@1.2.1"

# 2. Server (depends on core)
Publish-Package "packages\server"        "@afterlink/server@1.2.1"

# 3. Client (depends on core)
Publish-Package "packages\client"        "@afterlink/client@1.2.1"

# 4. Browser SDK (depends on core)
Publish-Package "packages\browser"       "@afterlink/browser@1.2.1"

# 5. CLI (depends on core)
Publish-Package "packages\cli"           "@afterlink/cli@1.2.1"

# 6. AI Assistant (NEW — first publish)
Publish-Package "packages\ai-assistant"  "@afterlink/ai-assistant@1.2.1"

# 7. Umbrella package (depends on all above)
Publish-Package "packages\afterlink"     "afterlink@1.2.1"
